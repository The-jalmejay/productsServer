const data=[
    ...
    },
    {
      ...
      imgLink:
        "https://www.quaysunglassesireland.com/images/quaysunglassesireland/Black_Smoke_Polarized_Men_s_Quay_HIGH_-12ITFSVJE.jpg",
      name: "Quay Shades",
      price: 479
    },
    {
...
const orders=[
  {id:1,name:"Ajay",address:"Barakar bus stand",city:"Kulti",totalPrice:2589,items:[{
    id: 1,
   category: "Watches",
   description:
     "The look that made Swiss watches the toast of the world. Still unbeatable.",
 ...
 },
 {
  ...
  {id:2,name:"Bijay",address:"Asansol police line",city:"Asansol",totalPrice:2799,items:[{
    id: 15,
   category: "Belts",
   description: "Signature belt from Gucci ",
   imgLink:
 ...
 },
 {
  ...
  {id:3,name:"Cijai",address:"Chirkunda ",city:"Chirkunda",totalPrice:589,items:[{
    id: 15,
   category: "Belts",
   description: "Signature belt from Gucci ",
   imgLink:
 ...
 },
 {
  ...
  {id:4,name:"Dijay",address:"Kumardubi ",city:"Kumardubi",totalPrice:5489,items:[ {
    id: 14,
   category: "Handbags",
   description: "3 Pockets, 2 Zips -  ideal for shopping and parties",
   imgLink:
     "https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
   name: "Chic Leather",quantity:1,
   price: 749
 },
 {
    id: 15,
   ...
   imgLink:
     "https://img.shopstyle-cdn.com/pim/c7/a6/c7a695a8db5a375b222f15bea045bdea_xlarge.jpg",
   name: "Raw Edge",quantity:1,
   price: 799
 },],email:"abc@gmail.com"},
  {id:5,name:"ethi",address:"Mugma ",city:"Mugma",totalPrice:5099,items:[{
    id: 1,
   category: "Watches",
   description:
     "The look that made Swiss watches the toast of the world. Still unbeatable.",
 ...
 },
 {
   ...
   imgLink:
     "https://images.pexels.com/photos/2113994/pexels-photo-2113994.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
   name: "Chronograph",quantity:1,
   price: 1199
 },],email:"abcd@gmail.com"},
  {id:6,name:"Fijay",address:"Nirsh ",city:"Nirsh",totalPrice:3489,items:[{
    id: 11,
   category: "Watches",
   description: "Apple Watch Version 2. A delight.",
   imgLink:
     "https://images.pexels.com/photos/277406/pexels-photo-277406.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
   name: "Apple v2",quantity:1,
   price: 1499
 },
 {
    id: 12,
   ...
   imgLink:
     "https://as1.ftcdn.net/jpg/02/14/48/72/500_F_214487233_Aahw3DohDu6dSSfMqWCcU1QDatxpDt6E.jpg",
   name: "Fab Brown",quantity:1,
   price: 149
 },],email:"abcd@gmail.com"},
  {id:7,name:"gajay",address:"Kumardubi Bazar ",city:"Kumardubi",totalPrice:459,items:[ {
    id: 4,
   category: "Watches",
   description: "For all ages. For all times. Classic Look. Classic leather.",
   imgLink:
     "https://images.pexels.com/photos/236915/pexels-photo-236915.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
   name: "Classic",quantity:1,
   price: 1250
 },
 {
    id: 5,
